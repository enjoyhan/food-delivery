![image](https://user-images.githubusercontent.com/33124483/122336547-ff869500-cf77-11eb-8c6a-747dda0cd301.png)
...
킥고잉 커버하기 - https://1sung.tistory.com/106

기능적 요구사항
1. 고객이 핸드폰, USIM, 요금제를 선택합니다.
2. 고객이 결제한다.
3. 결제가 되면 핸드폰과 USIM이 고객에게 배송된다
4. 고객이 주문을 취소할 수 있다
5. 주문이 취소되면 배송이 취소된다
6. 고객이 주문상태를 중간중간 조회한다
7. 주문상태가 바뀔 때 마다 카톡으로 알림을 보낸다

비기능적 요구사항
1. 트랜잭션
    1. 결제가 되지 않은 주문건은 아예 거래가 성립되지 않아야 한다  Sync 호출 
2. 장애격리
    1. 핸드폰 주문은 365일 24시간 받을 수 있어야 한다  Async (event-driven), Eventual Consistency
